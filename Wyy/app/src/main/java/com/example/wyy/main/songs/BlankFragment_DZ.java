...
public class
BlankFragment_DZ extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View cow= inflater.inflate(R.layout.fragment_blank__d_z, container, false);
        recyclerView=cow.findViewById(R.id.song_dz_recycle);
