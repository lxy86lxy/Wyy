...
public class Image2 extends AppCompatImageView {
    float width,height;
    public Image2(@NonNull  Context context) {
        this(context,null);
        init(context, null);
    }

    public Image2(@NonNull  Context context, @Nullable  AttributeSet attrs) {
        this(context, attrs,0);
        init(context, attrs);
    }

    public Image2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
