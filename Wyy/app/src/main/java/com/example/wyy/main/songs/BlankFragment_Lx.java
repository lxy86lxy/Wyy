...
public class BlankFragment_Lx extends Fragment {
    String address;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View cow= inflater.inflate(R.layout.fragment_blank__lx, container, false);
        recyclerView=cow.findViewById(R.id.song_lx_recycle);
